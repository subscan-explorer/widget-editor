...
import { ExplorerFieldDef, useExplorerContext, useSchemaContext } from '@graphiql/react';
import {
  GraphQLEnumValue,
  ...
  return (
    <div className="doc-category-item">
      ...
      {value.deprecationReason && (
        <MarkdownContent className="doc-deprecation" markdown={value.deprecationReason} />
      )}
    </div>
  );
}
