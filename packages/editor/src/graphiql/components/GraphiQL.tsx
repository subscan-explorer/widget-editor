    ...
    const toolbar = find(children, child =>
      ...
      <GraphiQL.Toolbar>
        ...
        <ToolbarButton
          ...
          title={this.props.historyContext?.isVisible ? 'Hide History' : 'Show History'}
          label="History"
        />
        <ToolbarButton
      ...
      <div data-testid="graphiql-container" className="graphiql-container">
        <div ref={this.props.docResize.firstRef}>
          {this.props.historyContext?.isVisible && (
            <div className="historyPaneWrap" style={{ width: '230px', zIndex: 7 }}>
              <QueryHistory />
            </div>
          )}
                    ...
                    >
                      <div
                        className={`variable-editor-title-text${
                          this.state.activeSecondaryEditor === 'variable' ? ' active' : ''
                        }`}
                        onClick={() => {
                          if (
                            this.props.secondaryEditorResize.hiddenElement === 'second'
                          ) {
