...
function hasProps<Child extends React.ReactNode>(child: Child): child is HasProps<Child> {
...
> {
  ...
  render() {
    ...
    const optionChildren = React.Children.map(this.props.children, (child, i) => {
      ...
      const onChildSelect =
        child.props.onSelect || this.props.onSelect?.bind(null, child.props.value, i);
