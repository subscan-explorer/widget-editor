...
import { ComponentSchema, createModule } from '@subscan/widget-core';
import { RegistryInterface, StateManagerInterface } from '@subscan/widget-runtime';
...
import type { Metadata } from '@subscan/widget-core';
